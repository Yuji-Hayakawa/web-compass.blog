...
function stk_classic_editor_select_style($init)
{
	...
	$c_editor_style_maker_green = array(
		'title' => 'マーカー（グリーン）',
		'inline' => 'span',
		'classes' => 'span-stk-maker-green',
	);
  ...
  $c_editor_style_index = array(
    ...
    $c_editor_style_maker_green,
  );

  $init['style_formats'] = json_encode($c_editor_style_index);
  return $init;
}
add_filter('tiny_mce_before_init', 'stk_classic_editor_select_style');
